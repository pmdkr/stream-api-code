...
//        System.out.println(employeeList.get(9));


        //find first employee whose salary is grater then 50000

        Optional<Employee> emp = employeeList.stream().filter(e -> e.getSalary() > 50000)
                .findFirst();
